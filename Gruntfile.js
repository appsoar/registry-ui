    ...
    watch: {
      ...
      livereload: {
        ...
        files: [
          '<%= yeoman.app %>/**/*.html',
          '.tmp/styles/{,*/}*.css',
          '<%= yeoman.app %>/icons/{,**/}*.{png,jpg,jpeg,gif,webp,svg}'
        ]
      }
    },
      ...
      livereload: {
        options: {
          ...
          middleware: function(connect) {
            ...
            middlewares.push(modRewrite(['!^/api/v0/|\\.html|\\.js|\\.svg|\\.css|\\.png|\\.woff2|\\.woff|\\.ttf|\\.jpg$ /index.html [L]']));
    ...
    filerev: {
      dist: {
        src: [
          ...
          '<%= yeoman.dist %>/icons/{,*/}*.{png,jpg,jpeg,gif,webp,svg}',
          '<%= yeoman.dist %>/icons/fonts/*'
        ]
      }
    },
    ...
    usemin: {
      ...
      options: {
        ...
        patterns: {
          ...
          html: [[/(icons\/[^''""]*\.(png|jpg|jpeg|gif|webp|svg))/g, 'Replacing references to images']]
        }
      }
    },
